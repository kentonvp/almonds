...
def test_create_user(sessionmaker_test):
    ...
    created_user = create_user(user_base, sessionmaker=sessionmaker_test)
...
def test_get_user_by_id(sessionmaker_test):
    ...
    retrieved_user = get_user_by_id(created_user.id, sessionmaker=sessionmaker_test)
...
def test_get_user_by_username(sessionmaker_test):
    ...
    retrieved_user = get_user_by_username("testuser", sessionmaker=sessionmaker_test)
...
def test_update_user(sessionmaker_test):
    ...
    result = update_user(updated_user, sessionmaker=sessionmaker_test)
...
def test_delete_user(sessionmaker_test):
    ...
    delete_user(created_user.id, sessionmaker=sessionmaker_test)
...
def test_get_nonexistent_user(sessionmaker_test):
    ...
    retrieved_user = get_user_by_id(non_existent_id, sessionmaker=sessionmaker_test)
    assert retrieved_user is None
